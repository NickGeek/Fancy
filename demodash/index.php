				...
				<div class="row">
					<div class="col-lg-12">
						...
						<div id="websiteInstructions" style="display: none;">
							...
							<ol>
								<li>Download these two files (<a href="javascript:void(0);" target="_blank">settings.php</a> and <a href="javascript:void(0);" target="_blank">FancyConnector.php</a>)</li>
						...
						<div id="blogInstructions" style="display: none;">
							...
							<ol>
								<li>Download these three files (<a href="javascript:void(0);" target="_blank">settings.php</a>, <a href="javascript:void(0);" target="_blank">FancyConnector.php</a>, and <a href="javascript:void(0);" target="_blank">fancy_blog.min.js</a>)</li>
